...
final class Sequence extends RightPaddings {
    ...
    public long getAcquire() {
        return (long) VALUE_VH.getAcquire(this);
    }
    ...
    public boolean weakCompareAndSetVolatile(long expected, long value) {
        return VALUE_VH.weakCompareAndSet(this, expected, value);
    }
